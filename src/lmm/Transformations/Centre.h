 ...
 */
#ifndef _CENTRE_VECTOR_TRANSFORM_H_
#define _CENTRE_VECTOR_TRANSFORM_H_
...
namespace gcat_lmm {
	...
	class CentreVectorTransform : public ContinuousVectorVariable, public Transformation {
	private:
		// Initialized?
		mutable bool _init;
		// Recalculate?
	...
	public:
		// Constructor
		CentreVectorTransform(string name="", DAG* dag=0);
		// Copy constructor
		CentreVectorTransform(const CentreVectorTransform& x);
...
#endif _CENTRE_VECTOR_TRANSFORM_H_
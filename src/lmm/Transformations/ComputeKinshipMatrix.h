 ...
 */
#ifndef _COMPUTE_KINSHIP_MATRIX_TRANSFORM_H_
#define _COMPUTE_KINSHIP_MATRIX_TRANSFORM_H_
...
namespace gcat_lmm {
	...
	class ComputeKinshipMatrixTransform : public SymmetricMatrixVariable, public Transformation {
	private:
		// Initialized?
		mutable bool _init;
		// Recalculate?
		...
		mutable vector<double> _f;
	public:
		// Constructor
		ComputeKinshipMatrixTransform(string name="", DAG* dag=0);
		// Copy constructor
		ComputeKinshipMatrixTransform(const ComputeKinshipMatrixTransform& x);
...
#endif _COMPUTE_KINSHIP_MATRIX_TRANSFORM_H_